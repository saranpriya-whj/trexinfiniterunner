...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   if(camera.x % 800===0){
    ...
    invisibleGround = createSprite(camera.x+300,height-60,windowWidth*30,10); 
    invisibleGround.visible =false;
    trex.depth = ground2.depth;
...
function reset(){
  ...
  //text("x:"+mouseX,displayWidth/2,50);
  //text("y:"+mouseY,displayWidth/2,100);
